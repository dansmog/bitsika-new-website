...
const activeTitleClass =
  "font-google-sans font-medium text-[20px] leading-[120%] tracking-[0]";
const inactiveTitleClass =
  "font-google-sans font-normal text-[20px] leading-[120%] tracking-[0]";
...
export default function GetStarted() {
  ...
  return (
    <section className="bg-white py-20">
      <Container>
        <div className="flex gap-12 items-start max-lg:flex-col">
          {/* Left: title + steps */}
          <div className="flex-1 max-w-140">
            <h2 className="font-google-sans font-normal text-[40px] leading-[114%] tracking-[-0.01em] mb-14 max-w-115">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div key={index} className="flex">
                    ...
                    <div className="flex-1 pb-3.75" style={{ paddingLeft: 19 }}>
                            ...
                            >
                              <div className="pt-3">
                                <div className="bg-[#F5F5F5] rounded-2xl px-5 py-4 flex flex-col gap-2">
                                  <h3 className={`${activeTitleClass} text-ink`}>
                                    {step.title}
                                  </h3>
                      ...
                      <AnimatePresence initial={false}>
                        {!isActive && (
                          ...
                          >
                            ...
                            >
                              <span className={`${inactiveTitleClass} text-ink-placeholder`}>
                                {step.title}
                              </span>
                            </button>
                          </motion.div>
          ...
          <div className="flex-1 flex items-center justify-center max-lg:w-full">
            <div className="bg-[#F6F6F6] rounded-3xl w-161 overflow-hidden h-112.25 flex items-start justify-center pt-14.25">
              <div className="relative">
                {/* Phone frame */}
                <div className="bg-black rounded-3xl w-82 h-178.25 overflow-hidden">
                  {/* Status bar */}
                  <div className="flex items-center justify-between px-5 pt-3 pb-2">
                    <span className="text-white text-xs font-semibold">16:06</span>
                    <div className="flex items-center gap-1">
                      <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0" y="6" width="3" height="6" rx="0.5" fill="white" />
                        <rect x="4" y="4" width="3" height="8" rx="0.5" fill="white" />
                      ...
                      <span className="text-white text-[10px] bg-[#3A3A3A] rounded px-1 font-semibold">72</span>
                    </div>
                  </div>
                  {/* Action icons */}
                  <div className="flex items-center justify-end gap-3 px-5 pb-4">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9 3.75V14.25M3.75 9H14.25" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="8" cy="8" r="5.25" stroke="white" strokeWidth="1.5" />
                      <path d="M12 12L15.75 15.75" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.div
                  animate={{
                    width: imageSizes[activeStep].width,
                    height: imageSizes[activeStep].height,
                  }}
                  transition={transition}
                  className="absolute left-1/2 -translate-x-1/2 top-22.5 rounded-2xl overflow-hidden shadow-lg"
                >
                  <Image
                    src={callOfDuty}
                    alt="Game screenshot"
